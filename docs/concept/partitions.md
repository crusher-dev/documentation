...
description:
  Overview of Crusher's partition system for time-series. This is an important
  feature that will help you craft more efficient queries.
---

Crusher offers the option to partition tables by intervals of time. Data for
